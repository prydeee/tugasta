                ...
                <div class="p-6 text-gray-900 light:text-gray-100">
                    <form action="{{ route('buku.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="id_buku" id="id_buku" class="border border-gray-300 p-2 w-full" required>
                            @error('id_buku')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_buku" id="nama_buku" class="border border-gray-300 p-2 w-full" required>
                            @error('nama_buku')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="pengarang" id="pengarang" class="border border-gray-300 p-2 w-full" required>
                            @error('pengarang')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">{{ __('Tambah') }}</button>
                    </form>
                </div>
            </div>
        </div>
